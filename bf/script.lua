...
local Tabs = {
    ...
    Player = Window:AddTab({ Title = "Player Tab", Icon = "baby" }),
    Teleport = Window:AddTab({ Title = "Teleport Tab", Icon = "palmtree" }),
    Fruit = Window:AddTab({ Title = "Devil Fruit Tab", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Dungeon Tab", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Race V4 Tab", Icon = "chevrons-right" }),
...
ImageButton.Image = "rbxassetid://16207970117"
...
spawn(function()
    while task.wait() do
        if _G.CakePrince then
            local cakePrinceEnemy = game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince")

            if cakePrinceEnemy or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                ...
                local cakeLoafMirror = game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other

                if cakeLoafMirror.Transparency == 0 and (CFrame.new(-1990.672607421875, 4532.99951171875, -14973.6748046875).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 then
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tau Tushita", Default = false })
